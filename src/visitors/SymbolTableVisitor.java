...
public interface SymbolTableVisitor {
    ...
    public void visit(SubProgramSpecification n);
    public void visit(ParameterList n);
    public void visit(ParameterDefinition n);
    public void visit(ParameterNameList n);
    public void visit(Mode n);
    public void visit(DeclarativePart n);
    public void visit(DeclarativeItem n);
    ...
    public void visit(ElsifStatements n);
    public void visit(LoopStatement n);
    public void visit(IteratorPart n);
